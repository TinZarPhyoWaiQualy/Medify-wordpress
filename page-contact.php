 ...
 <main>
                    ...
                    <div class="left-contact">
                        ...
                        <div class="contact-icon-wrapper">
                            <div class="contact-icon-flex">
                                <div class="contact-icon phone-icon"><img src="./assets/img/contact-us/call.png"
                                        alt="phone"></div>
                            ...
                            <div class="contact-icon-flex">
                                <div class="contact-icon phone-icon"><img src="./assets/img/contact-us/email.png"
                                        alt="email"></div>
                                <div class="contact-info">
                            ...
                            <div class="contact-icon-flex">
                                <div class="contact-icon phone-icon"><img src="./assets/img/contact-us/location.png"
                                        alt="phone"></div>
                                <div class="contact-info">
        ...
        <section class="contact-women-section">
            <div class="contact-women">
                <img src="./assets/img/contact-us/women.jpg" alt="women">
            </div>
        </section>
    </main>
