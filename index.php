    ...
    <section>
      <div class="logo-slider-wrapper">
        <div class="logo-slider-track">
          ...
          <div class="ad-slider">
            <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/sos.png" alt="sos" />
          </div>
          <div class="ad-slider">
            <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/sigma.png" alt="Sigma" />
          </div>
          <div class="ad-slider">
            <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/medix.png" alt="Medix" />
          </div>
          <div class="ad-slider">
            <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/health-care.png" alt="HealthCare" />
          </div>
          <div class="ad-slider">
            <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/circle.png" alt="circle" />
          </div>
          <div class="ad-slider">
            <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/wglab.png" alt="Lab" />
          </div>
          <div class="ad-slider">
            <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/united.png" alt="United" />
          </div>
    </section>
